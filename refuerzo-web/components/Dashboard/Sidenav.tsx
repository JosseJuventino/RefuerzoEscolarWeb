...
import {
    SearchIcon, LayoutDashboardIcon, BriefcaseIcon,
    PaletteIcon, UsersIcon, KeyIcon, MoreHorizontalIcon,
} from "lucide-react";
    ...
    return (
        <div className="hidden md:flex flex-col justify-between h-screen w-64 p-3 bg-[#003C71] text-white">
            <div className="space-y-4">
                <h1 className="text-xl font-bold">Jobsly</h1>
                ...
                <nav className="space-y-1">
                    <NavItem icon={LayoutDashboardIcon} label="Overview" />
                    <NavItem icon={BriefcaseIcon} label="Positions" badge="8" />
                    <NavItem icon={PaletteIcon} label="Branding" badge="New" badgeColor="bg-green-500" />
                    <NavItem icon={UsersIcon} label="Team Management" />
                    <NavItem icon={KeyIcon} label="API Key" />
                </nav>
            </div>
