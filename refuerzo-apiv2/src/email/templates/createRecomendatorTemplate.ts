...
export const recomendadorAccountCreatedTemplate = (nombre: string, temporaryPassword: string) => {
    return `
      <!DOCTYPE html>
      <html lang="es">
      <head>
          ...
          <title>Cuenta de Recomendador Creada</title>
          <style>
              body {
      ...
      <body>
          <div class="email-container">
              ...
              <div class="email-body">
                  <h1>Cuenta de Recomendador Creada</h1>
                  <p>Hola <strong>${nombre}</strong>,</p>
                  <p>Tu cuenta de recomendador ha sido creada exitosamente. A continuación, encontrarás los detalles de acceso:</p>
